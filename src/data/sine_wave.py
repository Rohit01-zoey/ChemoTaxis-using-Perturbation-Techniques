...
class SineWaveLoader2(SineWaveLoader):
    """Loads the entire dataset with the given parameters. Inherits from SineWaveLoader."""
    def __init__(self, n_samples, time_stamps, amplitude : list, frequency : list, phase : list) -> None:
